...
public abstract class AbstractMicrosoftSQLTest implements JdbcSource {
  protected final String TEMP_DB_DIR = "C:\\Users\\.temp";
  protected final String BERKLEY_DB_DIR = Paths.get(TEMP_DB_DIR).toAbsolutePath().normalize() + FILE_SEPARATOR + "mssql_test";
  protected BerkleyDB berkleyDB;

  protected final String DB_URL = "jdbc:sqlserver://localhost:1433;DatabaseName=master;encrypt=true;trustServerCertificate=true;";
  ...
  private final String tableNameRandom = "mssql_table_test_random";
  private final String tableNameAsh = "mssql_table_test_ash";
  ...
  public void initBackendAndLoad() {
    try {
      ...
      dbConnection = DriverManager.getConnection(DB_URL, "sa", "QOEfSsa51234!");
    } catch (Exception e) {
      log.catching(e);
