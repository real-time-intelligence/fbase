...
import org.fbase.storage.dialect.PgSqlDialect;
import org.fbase.util.CachedLastLinkedHashMap;

@Log4j2
public class RawPgSqlImpl extends QueryJdbcApi implements RawDAO {
  ...
  public RawPgSqlImpl(MetaModelApi metaModelApi,
                      BasicDataSource basicDataSource) {
    super(basicDataSource);

    this.metaModelApi = metaModelApi;

    this.databaseDialect = new PgSqlDialect();
