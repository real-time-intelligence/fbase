...
import org.fbase.storage.dialect.OracleDialect;
import org.fbase.util.CachedLastLinkedHashMap;

@Log4j2
public class RawOracleImpl extends QueryJdbcApi implements RawDAO {
  ...
  public RawOracleImpl(MetaModelApi metaModelApi,
